...
android {
    namespace = "com.kenway.robin"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.kenway.robin"
        minSdk = 24
        targetSdk = 34
        versionCode = 1
        versionName = "1.0"
    ...
    composeOptions {
        // Updated Compose Compiler to a version compatible with the new BOM
...
dependencies {
    ...
    // Room Database (has its own version)
